...
def calculate_cosine_similarity2(feature_maps1, feature_maps2):
    assert feature_maps1.shape == feature_maps2.shape, "Τα feature maps πρέπει να έχουν τις ίδιες διαστάσεις"
...
#avg_cos_sim1 = calculate_cosine_similarity(feature_maps1, feature_maps2)
#print(f'Η μέση τιμή του cosine similarity είναι: {avg_cos_sim1}')

#avg_cos_sim2 = calculate_cosine_similarity2(feature_maps1, feature_maps2)
#print(f'Η μέση τιμή του cosine similarity2 είναι: {avg_cos_sim1}')
