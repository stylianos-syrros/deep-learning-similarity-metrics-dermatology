...
class DISTS():
    def __init__(self):
        ...
        self.weights = scio.loadmat(r"D:\Diploma\DISTS_FINE_TUNE\SecondFineTune\Mat_files_second_training\epoch_1_alpha_beta.mat")
...
if __name__ == '__main__':
    ...
    #ref_image_path = r"C:\Users\steli\DIPLOMA\myProgramms\DISTS\DISTS-master\images\r0.png"
    #dist_image_path = r"C:\Users\steli\DIPLOMA\myProgramms\DISTS\DISTS-master\images\r1.png"
    #dist_image_path = r"C:\Users\steli\DIPLOMA\images\yeezyONIX.png"
    model = DISTS()
    ...
    with tf.Session() as sess:
        ...
        # Εκτύπωση των τιμών alpha και beta για την τρέχουσα εποχή
        ...
        print(f"DISTS distance (TensorFlow): {score}")
