...
# Set up logging
logging.basicConfig(filename="D:\\Diploma\\DISTS_FINE_TUNE\\SecondFineTune\\second_training_log.txt", level=logging.INFO, format='%(asctime)s:%(levelname)s:%(message)s')
...
def fine_tune_dists_multiple_epochs(train_dir, doctor_scores, epochs=25):
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(epochs):
            ...
            scio.savemat(f"D:\\Diploma\\DISTS_FINE_TUNE\\SecondFineTune\\Mat_files_second_training\\epoch_{epoch + 1}_alpha_beta.mat", {'alpha': current_alpha, 'beta': current_beta})
            ...
            if epoch_loss < best_loss:
                ...
                # Save best model
                scio.savemat("D:\\Diploma\\DISTS_FINE_TUNE\\SecondFineTune\\Mat_files_second_training\\best_model_alpha_beta.mat", {'alpha': best_alpha, 'beta': best_beta})
...
train_dir = r"C:\Users\steli\DIPLOMA\bcc\final_train"
...
test_dir = r"C:\Users\steli\DIPLOMA\bcc\final_test"
