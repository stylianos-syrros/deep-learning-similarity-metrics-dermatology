...
file_path_gpu = r"C:\Users\steli\DIPLOMA\myProgramms\XLSX\VGG16_Distances_Comparison.xlsx"
...
if torch.cuda.is_available():
    ...
    cases, case_distances_layer1, case_distances_layer2, gpu_duration = calculate_distances(base_model, layer_name1, layer_name2, 'CUDA (GPU)')
