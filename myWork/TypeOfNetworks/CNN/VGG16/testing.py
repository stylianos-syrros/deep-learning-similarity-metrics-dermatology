...
def calculate_cosine_similarity(feature_maps1, feature_maps2):
    """
    Υπολογίζει το cosine similarity μεταξύ δύο συνόλων feature maps.
    
    Args:
        feature_maps1: np.array, το πρώτο σύνολο feature maps.
        feature_maps2: np.array, το δεύτερο σύνολο feature maps.
    
    Returns:
        avg_cos_sim: float, η μέση τιμή του cosine similarity για όλα τα ζεύγη feature maps.
    """
