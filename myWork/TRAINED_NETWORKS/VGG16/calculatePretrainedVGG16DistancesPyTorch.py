...
# Ορισμός των μετασχηματισμών με τα mean και std του ImageNet
...
# Φόρτωση του προεκπαιδευμένου μοντέλου VGG16 στο ImageNet
...
file_path = r"C:\Users\steli\DIPLOMA\myProgramms\XLSX\VGG16_Distances_Pretrained.xlsx"
df = pd.DataFrame({
    'Folder': cases,
    '(pretrained_avg)block5_conv3': case_distances_layer1_avg,
    '(pretrained_avg)block5_relu3': case_distances_layer2_avg,
    '(pretrained_avg)avgpool': case_distances_layer3_avg,
    '(pretrained_flat)block5_conv3': case_distances_layer1_flat,
    '(pretrained_flat)block5_relu3': case_distances_layer2_flat,
    '(pretrained_flat)avgpool': case_distances_layer3_flat,
    '(pretrained_flat)ReLU': case_distances_layer4_flat,
    '(pretrained_flat)fc3': case_distances_layer5_flat,
})
