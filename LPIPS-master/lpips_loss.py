...
parser.add_argument('--ref_path', type=str, default=r"C:\Users\steli\DIPLOMA\bcc\CASE001\0.jpg")
parser.add_argument('--pred_path', type=str, default=r"C:\Users\steli\DIPLOMA\bcc\CASE001\1.jpg")
...
# Προσαρμογή των διαστάσεων των δύο εικόνων
ref = TF.resize(ref, (pred.size(2), pred.size(3)))
